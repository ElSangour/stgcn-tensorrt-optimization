#!/usr/bin/env python3
"""
Benchmark script for Single Person ST-GCN model (M=1)
...
# Configuration
PYTORCH_MODEL_PATH = "/home/wisevision/projects/stgcn-tensorrt-optimization/models/epoch60_model.pt"
TRT_ENGINE_PATH = "/home/wisevision/projects/stgcn-tensorrt-optimization/tensorrt_engines/stgcn_M1_fp16_optimized.engine"

# Model parameters for M=1 (single person)
IN_CHANNELS = 3
NUM_CLASS = 2
TEMPORAL_FRAMES = 150
VERTICES = 33
...
def main():
    ...
    print("\n" + "="*60)
    print("ST-GCN SINGLE PERSON (M=1) BENCHMARK")
    print("="*60)
